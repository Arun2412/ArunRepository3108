...
<body>
	<center>
		<h1>
			<img src="resources/images/arts/art.jpg"
				style="width: 50px; height: 50px"> ART COLLECTION
		</h1>
		<br>
	</center>
	<marquee>
		...
		<ul class="nav navbar-nav">
			...
			<li class="dropdown"><a class="dropdown-toggle"
				...
				<ul class="dropdown-menu">
					<li><a href="toAddItems">Add Arts</a></li>
					<li><a href="toViewAllItems">View Arts</a></li>
				</ul></li>
			<li class="dropdown"><a class="dropdown-toggle"
				data-toggle="dropdown" href="#">USERS <span class="caret"></span></a>
				<ul class="dropdown-menu">
					<li><a href="toSignUp">Add User</a></li>
					<li><a href="toViewCustomers">View Users</a></li>
				</ul></li>
		</ul>
